...
```json
{
  ...
  "bsGitRepository" : "github.com?owner=tfynes-pivotal&repo=tj17"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->tj17]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=tfynes-pivotal&repo=tj17'
